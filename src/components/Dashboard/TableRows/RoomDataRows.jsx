...
import UpdateRoomModal from '../../Model/UpdateRoomModal'
...
const RoomDataRow = ({ room, handleDelete }) => {
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <button onClick={() => SetUpdateOpen(true)} className='relative cursor-pointer inline-block px-3 py-1 font-semibold text-green-900 leading-tight'>
          <span
            aria-hidden='true'
        ...
        {/* Update Modal */}
        <UpdateRoomModal setIsEditModalOpen={setIsEditModalOpen} updateOpen={updateOpen}></UpdateRoomModal>
      </td>
    </tr>
  )
}
